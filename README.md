# Luanti Development Test (devtest)

This is a basic testing environment that contains a bunch of things to test the [Luanti](https://luanti.org/) engine, but it could also be used as a minimal testbed for testing out mods.
